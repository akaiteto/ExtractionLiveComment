...
　　　　　　　　　　**->->６－１にも書いたけど、音声認識で機械学習して、**<br>
　　　　　　　　　　**->->キーボード音を検知しようぜ！！！！（どうやるか知らない・やってみたいだけ）**<br>
...
　　　２－３　ライバーの雑音のない綺麗なサンプルボイスから、ライバーさんの特徴量を抽出。<br>
　　　　　　　配信のノイズやＢＧＭから、ライバーさんの音声を分離させて、<br>
　　　　　　　そこから何かしらのライブラリで音声をテキスト化させる！（個人的にやりたいだけ）<br>
   <br>
